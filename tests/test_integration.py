...
class TestAutoGenIntegrationTasks:
    ...
    def team(self, azure_credentials):
        """Create AutoGen team."""
        from agents.agent_service.autogen.team import AutoGenTeam
...
class TestCrewAIIntegrationTasks:
    ...
    def crew(self, azure_credentials):
        """Create CrewAI crew."""
        from agents.agent_service.crewai.crew import CrewAITeam
...
class TestOpenHandsIntegrationTasks:
    ...
    def team(self, azure_credentials):
        ...
        from agents.agent_service.openhands.team import OpenHandsTeam
