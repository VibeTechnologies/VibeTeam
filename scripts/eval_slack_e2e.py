    ...
    "support_sentry_to_pr": {
        ...
        "evaluation_criteria": {
            ...
            "EvidenceBasedDecision": (
                ...
                "(3) Closing a Sentry issue is evidence-based ONLY if done AFTER a fix PR is created/linked. "
                "IMPORTANT: This is a multi-agent team where SupportEngineer triages and "
                "@SoftwareEngineer creates PRs. The evidence chain is: "
                "identify issue with data → request PR with specific error details → PR created → close Sentry. "
                "Evaluate whether the FULL conversation shows this evidence chain, not just individual messages. "
                "SCORING: "
                ...
                "Score 0.6-0.8: Evidence cited and actions follow logically from findings. "
                "Score 0.8-1.0: Complete evidence chain — specific error data cited, PR addresses the error, Sentry closed after fix."
            ),
            "HandoffCompletion": (
                "If the agent handed off to another agent, did that handoff actually complete? "
